...
-- Level setups
function barebones:SetupLevel5()
  print("Setting up level 5")
  local level = 5
  local botleft1 = Entities:FindByName(nil, "bounds_bl5_1"):GetAbsOrigin()
  local topright1 = Entities:FindByName(nil, "bounds_tr5_1"):GetAbsOrigin()

  local botleft2 = Entities:FindByName(nil, "bounds_bl5_2"):GetAbsOrigin()
  local topright2 = Entities:FindByName(nil, "bounds_tr5_2"):GetAbsOrigin()

  -- Functions to run
  barebones:WallPatrolThinker(botleft1, topright1, true, 0, level, 200)
  barebones:WallPatrolThinker(botleft2, topright2, false, 0, level, 525)

  barebones:WallThinker()
end