...
function barebones:OnHeroInGame(hero)
	...
	Timers:CreateTimer(0.5, function()
		...
		local abil2 = hero:AddAbility("pudge_meat_hook_custom")
		local abil3 = hero:AddAbility("dark_seer_surge_custom")

		abil1:SetHidden(setVisible)
		abil2:SetHidden(setVisible)
		abil3:SetHidden(setVisible)
		abil4:SetHidden(setVisible)
		abil5:SetHidden(setVisible)
		...
		hero:AddAbility("special_bonus_unique_tiny_5"):SetLevel(1)
